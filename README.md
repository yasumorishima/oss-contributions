...
| [optuna](https://github.com/optuna/optuna) | Python | 4 | 3 | 1 | 0 |
...
| # | PR | Status | Description |
|---|---|---|---|
| 4 | [#6490](https://github.com/optuna/optuna/pull/6490) | Open | fix: move JSONSerializable import to TYPE_CHECKING in study/study.py |
